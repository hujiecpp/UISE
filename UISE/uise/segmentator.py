...
class UISE(nn.Module):
    def __init__(self, cfg):
        ...
        self.sem_seg_postprocess_before_inference = (cfg.MODEL.UISE.TEST.SEM_SEG_POSTPROCESSING_BEFORE_INFERENCE or cfg.MODEL.UISE.TEST.PANOPTIC_ON or cfg.MODEL.UISE.TEST.INSTANCE_ON)
        self.semantic_on = cfg.MODEL.UISE.TEST.SEMANTIC_ON
        self.instance_on = cfg.MODEL.UISE.TEST.INSTANCE_ON
        self.panoptic_on = cfg.MODEL.UISE.TEST.PANOPTIC_ON
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            #
            # print(mask_pred_results.shape) # 1, 100, h, w
            # upsample masks
