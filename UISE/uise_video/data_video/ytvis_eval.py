...
class YTVISEvaluator(DatasetEvaluator):
    ...
    def __init__(
        ...
        *,
        ...
        # print(self._do_evaluation)
        # print(self._ytvis_api.dataset)
...
# res = _evaluate_predictions_on_coco('/home/mac239/YOSO/datasets/ytvis_2019/valid.json', 
                                    # '/home/mac239/YOSO/output/yoso_resnet50_instance_seg_ytvis_2019/inference/results.json')